...
### INFO
Lägg in det event du vill använda. Antingen i en meny eller för ett knapptryck. Så här triggar du eventen:
TriggerEvent('pee') och TriggerEvent('poop')

### Exempel #1 - Ett knapptryck
```
